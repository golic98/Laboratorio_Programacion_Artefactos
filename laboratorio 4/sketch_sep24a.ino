...
#define AIO_USERNAME    "golic98"  // Tu usuario en Adafruit
#define AIO_KEY         "aio_oRFv62fkQlO1LEgf3bmOmgpAvisU"           // Tu clave AIO
...
/************** FEED DE PUBLICACIÓN **************/
Adafruit_MQTT_Publish pubTemp = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/boton");
